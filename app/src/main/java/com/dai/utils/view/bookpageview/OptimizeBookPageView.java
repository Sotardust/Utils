...
public class OptimizeBookPageView extends View {
    ...
    private int defaultWidth = Constant.WIDTH;//默认宽度
    private int defaultHeight = Constant.HEIGHT;//默认高度
    ...
    public OptimizeBookPageView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
...
//        String[] strings = context.getString(R.string.contentA).split(" ");
        ...
        for (String string : strings) {
            ...
            if (viewWidth > textWidth) {
                mCanvas.drawText(string, 0, height * total, textPaint);
                mCanvas.translate(0, 15);
            ...
            for (int j = 0; j < line; j++) {
                mCanvas.drawText(string.substring(start, end), 0, height * total, textPaint);
                total++;
                start = end;
                end = end + temp;
                ...
                lineHeightSum = lineHeightSum + lineHeight;
                mCanvas.translate(0, lineHeight);
            }
        }
