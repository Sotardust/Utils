package com.dai.utils.view.musicbutton;
...
public class MusicButton1 extends AppCompatImageView {
    ...
    public MusicButton1(Context context) {
        super(context);
        init();
    }

    public MusicButton1(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public MusicButton1(Context context, AttributeSet attrs, int defStyleAttr) {
